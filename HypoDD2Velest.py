...
outdir = 'E:\\My Drive\\Tomography\\coding\\250622\\Output_velest\\'

#### SEARCH INPUT FILE FOR GIVEN FOLDER PATH ################
sfiles = glob.glob('E:\\My Drive\\Tomography\\coding\\250622\\*.dat')
...
#    print('Read Data from File:',sfile)
    baris = fin.readlines()
    outfile = outdir+'/{0:s}.cnv'.format(sfile.split('\\')[5].split('.')[0])
    fout = open(outfile,'w')
